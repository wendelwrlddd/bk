            ...
            $('#step-3').html(`
                <div class="bg-white rounded-xl shadow-lg p-6 max-w-md mx-auto">
                    ...
                    <div class="space-y-3 mb-8">
                        ...
                        <button class="w-full bg-blue-400 text-white font-bold py-3 rounded-lg flex justify-center items-center gap-2 cursor-not-allowed opacity-90 shadow-inner" disabled>
